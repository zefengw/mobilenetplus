...
import { MobileProduct } from '@/app/types/product'
...
export default function MobilePage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      ...
      try {
        const productsRef = collection(db as Firestore, 'products', 'mobile', 'items')
        const q = query(
          productsRef,
          where('active', '==', true),
          orderBy('price', 'asc')
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-8">Mobile Plans</h1>
