      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between items-start">
          ...
          <div className="w-full md:w-1/4">
            ...
            <p className="text-gray-600 mb-2">123 MobileNet Street</p>
            <p className="text-gray-600 mb-2">Cityville, State 12345</p>
            <p className="text-gray-600 mb-2">Phone: (123) 456-7890</p>
            <p className="text-gray-600">Email: info@mobilenetplus.com</p>
          </div>
        </div>
